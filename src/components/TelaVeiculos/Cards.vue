    ...
    <v-row>
        ...
        <v-hover>
          <template v-slot:default="{ hover }">
            <v-card class="mx-auto" max-width="344" max-height="550" color="grey lighten-4">
              <v-img :src="carro.fotos? carro.fotos[0] : ''" height="300px"></v-img>
      ...
      <v-dialog v-if="dialog" v-model="dialog" max-width="800px">
        <v-card>
          ...
          <v-carousel :continuous="false" :height="height" hide-delimiters>
          ...
          <v-card-text class="pa-0">
            <v-container>
              ...
              <v-divider></v-divider>
              <v-row>
                <p class="my-1 mt-6 ml-4"><strong>Endereço:</strong> Rua Raimundo Carneiro 123</p>
              </v-row>
              <v-row>
                <p class="my-1 ml-4 mb-6">
                  <strong>Funcionamento:</strong> Segunda à Sexta | 9h00 às 18h00 e aos
              ...
              <v-col xs="12" >
                <p class="ml-n2"><strong>Beethoven:</strong></p>
                  <v-btn
                    class="ml-n3"
              ...
              <v-col xs="12">
                <p class="ml-n2"><strong>Roberto:</strong></p>
                  <v-btn
                  class="ml-n3"
                    href="https://api.whatsapp.com/send/?phone=5511945290686&text=Olá+tudo+bem?&app_absent=0"
                    color="green"
