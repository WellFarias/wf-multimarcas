      ...
      <br />
        <v-row> 
          <v-col xs="12" sm="12" md="12" lg="6">
            ...
            <p style=" margin-left: 10px; margin-right: 20px line-height: 30px; font-size: 15px; color:white">
            What is Lorem Ipsum?
          ...
          <v-col xs="12" sm="12" md="12" lg="6" >
            <v-img max-width="100%" style="margin-right: 10px; margin-left: 10px" src="/loja-de-carros.jpg" />
          </v-col>
